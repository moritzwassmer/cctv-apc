...
# This script runs a training for the CNN-vLSTM with masked loss.
...
echo "$formatted_date"
export EXP_NAME_SHORT=cnn-vlstm-masked
...
export MLFLOW_CREDS=$GIT_REPO/mlflow_creds/eval.yaml
